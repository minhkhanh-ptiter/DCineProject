...
public class BookingService {
    ...
    public BookingResponse createBooking(Long showtimeId, List<String> requestedSeats){
        ...
        for (BookingRequest.SeatRequest seatItem : req.get)
    ...
    public List<String> validateSeatConflicts(Long showtimeId, List<String> requestedSeats){
        ...
        List<String> conflictSeats = bookingSeatRepo.findConflict(showtimeId, seatIds);

        if (!conflictSeats.isEmpty()) {
            return conflictSeats; // ghế đã được đặt
        }
